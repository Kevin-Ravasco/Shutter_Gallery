...
class PasswordField(forms.CharField):
    ...
    def __init__(self, *args, **kwargs):
        ...
        kwargs['widget'] = forms.PasswordInput(render_value=render_value,
                                               attrs={'class': 'input--style-3', 'placeholder':
                                                      kwargs.get("label")})
...
class LoginForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if app_settings.AUTHENTICATION_METHOD == AuthenticationMethod.EMAIL:
            login_widget = forms.TextInput(attrs={'type': 'email', 'class': 'input--style-3',
                                                  'placeholder':
                                                  _('E-mail address'),
                                                  'autofocus': 'autofocus'})
            ...
            login_widget = forms.TextInput(attrs={'placeholder':
                                                  _('Username'), 'class': 'input--style-3',
                                                  'autofocus': 'autofocus'})
            ...
            login_widget = forms.TextInput(attrs={'placeholder':
                                                  _('Username or e-mail'), 'class': 'input--style-3',
                                                  'autofocus': 'autofocus'})
...
class BaseSignupForm(_base_signup_form_class()):
    ...
    email = forms.EmailField(widget=forms.TextInput(
        attrs={'type': 'email', 'class': 'input--style-3',
    ...
    def __init__(self, *args, **kwargs):
        ...
        if app_settings.SIGNUP_EMAIL_ENTER_TWICE:
            self.fields["email2"] = forms.EmailField(
                ...
                widget=forms.TextInput(
                    attrs={
                        'type': 'email', 'class': 'input--style-3',
